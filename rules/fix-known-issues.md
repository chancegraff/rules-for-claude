...
Boundary: this covers defects (wrong behavior, reachable bugs, broken contracts), not style modernization. A style-rule deviation in code this change already touches is fixed with the touch; elsewhere it is left alone, and sweeping for it is churn.
