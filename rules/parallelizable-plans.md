...
3. Verifier (sequential, fresh agent). Independent re-run of typecheck, lint, full test suites; reads modified files for split-decision compliance; sweeps the diff for `any`, type casts, em-dashes.
